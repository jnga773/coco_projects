function prob_out = apply_lingap_conditions(prob_in, data_in, bcs_funcs_in, lingap_in)
  ...
  bcs_linphase = bcs_funcs_in.bcs_linphase;
  ...
  % prob = coco_add_pars(prob, 'pars_lins', [uidx_lins(lingap_idx)], {'lingap'}, 'inactive');
