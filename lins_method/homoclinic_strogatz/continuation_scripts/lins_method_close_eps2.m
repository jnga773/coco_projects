...
% Add event for when eps2 gets small enough
...
%                  seg_u  - Distance of initial point of stable trajectory
%                           to point on \Sigma plane.
%                  mu     - System parameter.

coco(prob, run_new, [], 1, {'eps2', 'T1', 'T2', 'seg_u', 'mu'}, [1e-4, eps2]);
...
%     Plot     %
%--------------%
plot_homoclinic_manifold_run(run_new, label_plot, 5, p0_L, save_figure);
