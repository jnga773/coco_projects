...
coco(prob, run_new, [], 1, {'eps1', 'T1', 'T2', 'seg_u', 'mu'}, [1e-4, eps1]);
% coco(prob, run_new, [], 1, {'eps1', 'seg_u', 'mu'}, [1e-4, eps1]);
...
%     Plot     %
%--------------%
plot_homoclinic_manifold_run(run_new, label_plot, 4, p0_L, save_figure);
