...
\begin{table}[h]
  ...
  \begin{tabular}{l|l|l|l}
    \textbf{Setting} & \textbf{Description}                                                                                             & \textbf{Value Type} & \textbf{Default Value} \\[1ex] \hline
    \verb!var!       & \begin{tabular}[c]{@{}l@{}}Enable/disable temporay storage of solution to\\ variational problem\end{tabular}     & logical             & \verb!false!           \\[1ex]
    ...
    \verb!NBItMX!    & Discretisation error tolerance                                                                                   & integer             & \verb!10!              \\[1ex]
    ...
    \verb!TOLINC!    & \begin{tabular}[c]{@{}l@{}}Upper bound on discretisation error in window\\ of adapation\end{tabular}             & float               & \verb!2e-5!            \\[1ex]
    \verb!TOLDEC!    & \begin{tabular}[c]{@{}l@{}}Lower bound on discretisation error in window\\ of adapation\end{tabular}             & float               & \verb!5e-6!            \\[1ex]
