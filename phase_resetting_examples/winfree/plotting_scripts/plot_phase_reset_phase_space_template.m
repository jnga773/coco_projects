function plot_phase_reset_phase_space_template(ax_in, run_in, label_in)
  ...
  d_vec_plot = [[gamma_0(1), gamma_0(1) + (A * d_vec(1))];
                [gamma_0(2), gamma_0(2) + (A * d_vec(2))]];
  ...
  % Plot segment 4
  plot(ax_in, x4(:, 1), x4(:, 2), Color=colours(4, :), ...
  ...
  % Grid lines
  ax_in.GridLineWidth = 0.5; ax_in.GridColor = 'black'; ax_in.GridAlpha = 0.25;
