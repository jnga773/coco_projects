function prob_out = glue_PR_conditions(prob_in, data_in)
  ...
  prob = coco_add_func(prob, 'bcs_PR_seg3', @bcs_PR_seg3, data3, 'zero', 'uidx', ...
  ...
  prob = coco_add_pars(prob, 'pars_seg4', ...
                       uidx4(maps4.x0_idx), {'x1'; 'x2'}, 'active');
  ...
  prob = coco_add_func(prob, 'singular', @distance_to_singularity, dataep, ...
