%=========================================================================%
%          FITZHUGH-NAGUMO MODEL (FINDING PERIODIC ORBIT ode45)           %
%=========================================================================%
% Doing an example from this paper "A Continuation Approach to Calculating
% Phase Resetting Curves" by Langfield et al.
%
% Here we compute a periodic orbit of the FitzHugh-Nagumo model using
% ode45. We set this as an initial solution to the 'PO' toolbox to find a
% periodic orbit.
%
