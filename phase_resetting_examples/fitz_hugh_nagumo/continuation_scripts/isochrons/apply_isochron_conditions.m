function prob_out = apply_isochron_conditions(prob_in, data_in, bcs_funcs_in)
  % prob_out = apply_isochron_conditions(prob_in)
  %
  ...
  % Isochron check
  % dim_data.isochron_check = calculating_isochrons;
  dim_data.isochron_check = true;
  ...
  prob = coco_add_func(prob, 'singular', @distance_to_singularity, dim_data, ...
                       'active', {'EP_distance', 'EP_delta_x'}, 'uidx', ...
                       [uidx4(maps4.x0_idx); ...
                        uidxep(mapsep.x_idx)]);
