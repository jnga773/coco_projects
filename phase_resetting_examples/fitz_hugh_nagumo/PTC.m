%=========================================================================%
%             FITZHUGH-NAGUMO MODEL (PHASE TRANSITION CURVES)             %
%=========================================================================%
% Doing an exmaple from this paper "A Continuation Approach to Calculating
% Phase Resetting Curves" by Langfield et al.
%
% In this script we compute a set of phase transition curves (PTCs) for a
% fixed perturbation direction, and for a select few perturbation
% amplitudes.
%
% This script is set out in three main sections:
%
